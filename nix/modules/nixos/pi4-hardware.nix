{ ... }: {
  ...
  hardware.raspberry-pi.config.pi4.dt-overlays.rpi-poe.params = {
    poe_fan_temp0  = { enable = true; value = "50000"; }; # 50°C — fan starts
    poe_fan_speed0 = { enable = true; value = "0";     };
    poe_fan_temp1  = { enable = true; value = "60000"; }; # 60°C — ~33%
    poe_fan_speed1 = { enable = true; value = "85";    };
    poe_fan_temp2  = { enable = true; value = "70000"; }; # 70°C — ~67%
    poe_fan_speed2 = { enable = true; value = "170";   };
    poe_fan_temp3  = { enable = true; value = "75000"; }; # 75°C — full
    poe_fan_speed3 = { enable = true; value = "255";   };
  };
